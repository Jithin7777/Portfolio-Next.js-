    ...
    <div className="px-4 py-20 sm:px-8 lg:px-12">
      ...
      <div className="flex justify-center mt-8">
        <Image
          ...
          alt="Profile"
          className="w-32  h-36 sm:w-32  lg:w-40 lg:h-44 rounded-full object-cover border-4 mb-1 border-green-200  shadow-2xl"
        />
      </div>

      {/* Greetings */}
      <h2 className="flex font-Ovo  text-2xl gap-2 items-center  md:text-5xl justify-center pt-6 sm:pt-10 text-center">
      ...
      <motion.h1
        className="font-Ovo text-2xl sm:text-4xl lg:text-5xl xl:text-[56px] text-center leading-snug mt-3"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, ease: "easeInOut" }}
      >
        <span className="text-green-500">Full Stack Developer </span>based in Kerala
      </motion.h1>

      {/* Description */}
      <p className="max-w-2xl font-Ovo text-sm sm:text-base lg:text-lg font-medium text-center mx-auto mt-3 ">
      ...
      {/* Buttons */}
      <div className="flex flex-row sm:flex-row items-center justify-center gap-4 mt-8">
        <a
          href="#contact"
